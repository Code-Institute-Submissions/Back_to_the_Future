$(document).ready(function() {
	...
	var items = new vis.DataSet([
		...
		{id: 14, content: "Marty finds the young Doc Brown and shows him the time machine from thirty years in Doc’s future.", start: "1955-11-05, 19:00", className: "vis-item-custom", group: "1"},
		...
		{id: 20, content: "After fitting the DeLorean with a detachable pole and hook (directed into the flux capacitor when attached), Doc uses a model of the town — plus a wind-up toy car and a live electric cable — to demonstrate to Marty the plan on getting him back to the future.", start: "1955-11-08, 12:00", className: "vis-item-custom", group: "1"},
		...
		{id: 24, content: "Marty borrows Doc’s car to take Lorraine to the dance, but Biff steals her away. Biff's cronies lock Marty inside the trunk of Marvin Berry's car, they have a brief altercation with the band. Marvin cuts his hand helping Marty.", start: "1955-11-12, 21:30", className: "vis-item-custom", group: "1"},
		...
		{id: 32, content: "Old Biff, age 78, who has been waiting for this opportunity for three decades, steals the DeLorean and heads back to 1955 with Marty’s sports almanac.", start: "2015-10-21, 17:45", className: "vis-item-custom", group: "2"},
		...
		{id: 42, content: "Marty, hiding in the back seat of the car, is an intimate witness to Old Biff’s demonstration of the power of the almanac, but he does not interfere, as Doc has advised.", start: "1955-11-12, 15:05", className: "vis-item-custom", group: "2"},
		{id: 43, content: "Thinking he’s done enough to change the future, and intending to escape detection, Old Biff departs in the DeLorean to the same moment he departed in 2015.", start: "1955-11-12, 18:38", className: "vis-item-custom", group: "2"},
		...
		{id: 46, content: "After much wasted time and effort, Marty ultimately retrieves the almanac from Biff’s car.", start: "1955-11-12, 21:35", className: "vis-item-custom", group: "2"},
	...
	$("div.vis-item").click(function() {
		$("div.vis-item").toggleClass("vis-item-custom");
	});
});